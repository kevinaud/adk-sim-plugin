/**
 * @fileoverview Content detection service for smart content rendering.
 *
 * Provides utilities to detect whether a string contains valid JSON
 * or markdown content, enabling components to auto-select the best
 * rendering mode.
 *
 * This service is placed in util/ to allow both data-tree and smart-blob
 * components to use it without creating circular dependencies.
 *
 ...
 *
 * Used by SmartBlobComponent and DataTreeComponent to determine which
 * rendering modes should be available for a given content string.
 *
 * @example
 * ```typescript
