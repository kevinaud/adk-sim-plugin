...
- All fragment anchors point to existing headings
- Warns about duplicate heading slugs (ambiguous anchors)
...
- You need to understand overall structure
- You're editing the document
- Multiple sections are relevant
...
3. **Run validation** before committing: `python .claude/skills/markdown-docs/scripts/validate_links.py mddocs/`
